//Equivale a la session 10 de ivan 

//.map retorna un arreglo con la misma cantidad de elementos que del arreglo que se itero 
...
const filteringVocals = mentorsArray.filter(( mentor )=>{
    mentor.name[0].match(/[aeiou]/gi)
})